...
Note that this does not directly support shell command lines. If you need to use
shell command lines, you need to explicitly call the shell implementation of
your choice, e.g:
